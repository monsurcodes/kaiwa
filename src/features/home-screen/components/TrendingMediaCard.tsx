...
import { HomeTrendingMediaItem } from "../types";
...
export const TrendingMediaCard = ({ media, mediaType, cardWidth }: TrendingMediaCardProps) => {
   ...
   const handleOnPress = (mediaType: MediaType) => {
