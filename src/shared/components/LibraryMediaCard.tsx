...
import { useSaveMediaListEntry } from "@/shared/hooks/useSaveMediaListEntry";
...
const LibraryMediaCard = ({
   ...
   const handlePlusPress = async () => {
      await savePlusEntry(type === "ANIME" ? "ANIME" : "MANGA");
   };

   const handleMinusPress = async () => {
      await saveMinusEntry(type === "ANIME" ? "ANIME" : "MANGA");
   };
